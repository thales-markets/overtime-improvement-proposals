...
|---------|-----------|-----------|-----------|-----------|-----------|-----------|
| OIP-258 | Introduce Chainlink-Verified Ticket Cashout | Draft | Danijel | Introduce early ticket cashout allowing users to exit prematch and live parlays using Chainlink-verified pricing | https://discord.gg/thales | 2026-02-27 |
