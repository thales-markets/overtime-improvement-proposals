...
| ----------- | ----------- | ----------- | ----------- | ----------- | ----------- | ----------- |
| OIP-256 | Casino Smart Contract Integration & RNG-Based Games | Draft | Danijel | Enable on-chain casino-style games using smart contracts and Chainlink VRF to diversify protocol revenue | https://discord.gg/thales | 2026-02-02 |
